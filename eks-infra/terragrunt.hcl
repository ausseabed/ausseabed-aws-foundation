locals {
  ...
  s3_backend_keys      = map(
  "831535125571", "env:/prod/terraform/eks-infra/terraform-aws-foundation-eks-infra.tfstate",
  "288871573946", "terraform/eks-infra/terraform-aws-foundation-eks-infra.tfstate"
  )
