locals {
  ...
  s3_backend_keys      = map(
  "831535125571", "env:/prod/terraform/wh-infra/terraform-aws-foundation-wh-infra.tfstate",
  "288871573946", "terraform/wh-infra/terraform-aws-foundation-wh-infra.tfstate"
  )
  ...
  "831535125571", "007391679308.dkr.ecr.ap-southeast-2.amazonaws.com/ausseabed-geoserver:0.0.5",
